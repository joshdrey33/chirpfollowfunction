                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('teachers.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="birth_date" id="birth_date" class="block mt-1 w-full border-gray-300 rounded">
                        </div>

                        <div class="flex items-center justify-end">
                            <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded">Save Teacher</button>
                        </div>
                    </form>
                </div>
            </div>
